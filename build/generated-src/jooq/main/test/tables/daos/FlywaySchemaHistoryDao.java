...
public class FlywaySchemaHistoryDao extends DAOImpl<FlywaySchemaHistoryRecord, test.tables.pojos.FlywaySchemaHistory, Integer> {

    /**
     * Create a new FlywaySchemaHistoryDao without any configuration
     */
    public FlywaySchemaHistoryDao() {
        super(FlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY, test.tables.pojos.FlywaySchemaHistory.class);
    }
    ...
    public FlywaySchemaHistoryDao(Configuration configuration) {
        super(FlywaySchemaHistory.FLYWAY_SCHEMA_HISTORY, test.tables.pojos.FlywaySchemaHistory.class, configuration);
    }

    @Override
    public Integer getId(test.tables.pojos.FlywaySchemaHistory object) {
     ...
     * upperInclusive</code>
     */
    public List<test.tables.pojos.FlywaySchemaHistory> fetchRangeOfInstalledRank(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<test.tables.pojos.FlywaySchemaHistory> fetchByInstalledRank(Integer... values) {
     ...
     */
    public test.tables.pojos.FlywaySchemaHistory fetchOneByInstalledRank(Integer value) {
     ...
     * upperInclusive</code>
     */
    public List<test.tables.pojos.FlywaySchemaHistory> fetchRangeOfVersion(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<test.tables.pojos.FlywaySchemaHistory> fetchByVersion(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<test.tables.pojos.FlywaySchemaHistory> fetchRangeOfDescription(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<test.tables.pojos.FlywaySchemaHistory> fetchByDescription(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<test.tables.pojos.FlywaySchemaHistory> fetchRangeOfType(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<test.tables.pojos.FlywaySchemaHistory> fetchByType(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<test.tables.pojos.FlywaySchemaHistory> fetchRangeOfScript(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<test.tables.pojos.FlywaySchemaHistory> fetchByScript(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<test.tables.pojos.FlywaySchemaHistory> fetchRangeOfChecksum(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<test.tables.pojos.FlywaySchemaHistory> fetchByChecksum(Integer... values) {
     ...
     * upperInclusive</code>
     */
    public List<test.tables.pojos.FlywaySchemaHistory> fetchRangeOfInstalledBy(String lowerInclusive, String upperInclusive) {
     ...
     */
    public List<test.tables.pojos.FlywaySchemaHistory> fetchByInstalledBy(String... values) {
     ...
     * upperInclusive</code>
     */
    public List<test.tables.pojos.FlywaySchemaHistory> fetchRangeOfInstalledOn(LocalDateTime lowerInclusive, LocalDateTime upperInclusive) {
     ...
     */
    public List<test.tables.pojos.FlywaySchemaHistory> fetchByInstalledOn(LocalDateTime... values) {
     ...
     * upperInclusive</code>
     */
    public List<test.tables.pojos.FlywaySchemaHistory> fetchRangeOfExecutionTime(Integer lowerInclusive, Integer upperInclusive) {
     ...
     */
    public List<test.tables.pojos.FlywaySchemaHistory> fetchByExecutionTime(Integer... values) {
     ...
     * upperInclusive</code>
     */
    public List<test.tables.pojos.FlywaySchemaHistory> fetchRangeOfSuccess(Boolean lowerInclusive, Boolean upperInclusive) {
     ...
     */
    public List<test.tables.pojos.FlywaySchemaHistory> fetchBySuccess(Boolean... values) {
